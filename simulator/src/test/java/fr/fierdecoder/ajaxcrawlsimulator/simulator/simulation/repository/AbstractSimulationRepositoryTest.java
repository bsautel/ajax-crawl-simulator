...
public abstract class AbstractSimulationRepositoryTest {
    ...
    public static final SimulationDescriptor A_SIMULATION_DESCRIPTION = new SimulationDescriptor(NAME, A_URL, A_URL);
    @Mock
    ...
    private Simulation createSimulation(SimulationDescriptor descriptor) {
        return new Simulation(descriptor, crawlStateFactory.create(descriptor.getName()));
    }
    ...
    public void shouldReturnDescriptors() {
        ...
        SimulationDescriptor anotherSimulationDescription = new SimulationDescriptor("another name", "url", "url");
